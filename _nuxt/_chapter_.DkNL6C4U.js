var Qt=Object.defineProperty;var Jt=(b,n,e)=>n in b?Qt(b,n,{enumerable:!0,configurable:!0,writable:!0,value:e}):b[n]=e;var wt=(b,n,e)=>(Jt(b,typeof n!="symbol"?n+"":n,e),e);import{g as Pt,G as Vt,H as Ft,o as ft,c as Wt,a as _t,C as yt,w as Kt,I as Xt,A as Yt}from"./entry.DKrbjni9.js";import{g as Gt,c as te}from"./_commonjsHelpers.Cpj98o6Y.js";import ee from"./nlesc-decorations.fio-yYFF.js";import ne from"./ContentRenderer.DmAANLig.js";import se from"./ContentDoc.CRZQ1DmV.js";import"./ContentRendererMarkdown.vue.IL5XJTtS.js";import"./head.PNcIIKeO.js";import"./vue.f36acd1f.BUEw-tCY.js";import"./ContentQuery.BRyAQXff.js";function re(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}let it={async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1};const Ot=/[&<>"']/,ie=new RegExp(Ot.source,"g"),Dt=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,ae=new RegExp(Dt.source,"g"),le={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Rt=b=>le[b];function J(b,n){if(n){if(Ot.test(b))return b.replace(ie,Rt)}else if(Dt.test(b))return b.replace(ae,Rt);return b}const oe=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;function Zt(b){return b.replace(oe,(n,e)=>(e=e.toLowerCase())==="colon"?":":e.charAt(0)==="#"?e.charAt(1)==="x"?String.fromCharCode(parseInt(e.substring(2),16)):String.fromCharCode(+e.substring(1)):"")}const ce=/(^|[^\[])\^/g;function H(b,n){b=typeof b=="string"?b:b.source,n=n||"";const e={replace:(t,a)=>(a=(a=a.source||a).replace(ce,"$1"),b=b.replace(t,a),e),getRegex:()=>new RegExp(b,n)};return e}const pe=/[^\w:]/g,he=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function It(b,n,e){if(b){let t;try{t=decodeURIComponent(Zt(e)).replace(pe,"").toLowerCase()}catch{return null}if(t.indexOf("javascript:")===0||t.indexOf("vbscript:")===0||t.indexOf("data:")===0)return null}n&&!he.test(e)&&(e=function(t,a){dt[" "+t]||(ue.test(t)?dt[" "+t]=t+"/":dt[" "+t]=mt(t,"/",!0)),t=dt[" "+t];const p=t.indexOf(":")===-1;return a.substring(0,2)==="//"?p?a:t.replace(de,"$1")+a:a.charAt(0)==="/"?p?a:t.replace(ge,"$1")+a:t+a}(n,e));try{e=encodeURI(e).replace(/%25/g,"%")}catch{return null}return e}const dt={},ue=/^[^:]+:\/*[^/]*$/,de=/^([^:]+:)[\s\S]*$/,ge=/^([^:]+:\/*[^/]*)[\s\S]*$/,xt={exec:function(){}};function Lt(b,n){const e=b.replace(/\|/g,(a,p,c)=>{let h=!1,x=p;for(;--x>=0&&c[x]==="\\";)h=!h;return h?"|":" |"}).split(/ \|/);let t=0;if(e[0].trim()||e.shift(),e.length>0&&!e[e.length-1].trim()&&e.pop(),e.length>n)e.splice(n);else for(;e.length<n;)e.push("");for(;t<e.length;t++)e[t]=e[t].trim().replace(/\\\|/g,"|");return e}function mt(b,n,e){const t=b.length;if(t===0)return"";let a=0;for(;a<t;){const p=b.charAt(t-a-1);if(p!==n||e){if(p===n||!e)break;a++}else a++}return b.slice(0,t-a)}function Ct(b,n){if(n<1)return"";let e="";for(;n>1;)1&n&&(e+=b),n>>=1,b+=b;return e+b}function Mt(b,n,e,t){const a=n.href,p=n.title?J(n.title):null,c=b[1].replace(/\\([\[\]])/g,"$1");if(b[0].charAt(0)!=="!"){t.state.inLink=!0;const h={type:"link",raw:e,href:a,title:p,text:c,tokens:t.inlineTokens(c)};return t.state.inLink=!1,h}return{type:"image",raw:e,href:a,title:p,text:J(c)}}class St{constructor(n){this.options=n||it}space(n){const e=this.rules.block.newline.exec(n);if(e&&e[0].length>0)return{type:"space",raw:e[0]}}code(n){const e=this.rules.block.code.exec(n);if(e){const t=e[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:e[0],codeBlockStyle:"indented",text:this.options.pedantic?t:mt(t,`
...
`),w.markdown=y[0]&&typeof y[0].getAttribute("data-markdown")=="string"),s.postMessage(JSON.stringify(w),"*")}function f(u){if(function(k){try{return window.location.origin===k.source.location.origin}catch{return!1}}(u)){let k=JSON.parse(u.data);k&&k.namespace==="reveal-notes"&&k.type==="connected"?(clearInterval(R),d()):k&&k.namespace==="reveal-notes"&&k.type==="call"&&function(y,A,w){let S=i[y].apply(i,A);s.postMessage(JSON.stringify({namespace:"reveal-notes",type:"return",result:S,callId:w}),"*")}(k.methodName,k.arguments,k.callId)}}function d(){i.on("slidechanged",l),i.on("fragmentshown",l),i.on("fragmenthidden",l),i.on("overviewhidden",l),i.on("overviewshown",l),i.on("paused",l),i.on("resumed",l),l()}return{id:"notes",init:function(u){i=u,/receiver/i.test(window.location.search)||(window.location.search.match(/(\?|\&)notes/gi)!==null?r():window.addEventListener("message",k=>{if(!s&&typeof k.data=="string"){let A;try{A=JSON.parse(k.data)}catch{}A&&A.namespace==="reveal-notes"&&A.type==="heartbeat"&&(y=k.source,s&&!s.closed?s.focus():(s=y,window.addEventListener("message",f),d()))}var y}),i.addKeyBinding({keyCode:83,key:"S",description:"Speaker notes view"},function(){r()}))},open:r}}})})(jt);var xe=jt.exports;const be=Gt(xe);/*!
 * Handles finding a text string anywhere in the slides and showing the next occurrence to the user
 * by navigatating to that slide and highlighting it.
 *
 * @author Jon Snyder <snyder.jon@gmail.com>, February 2013
 */const we=()=>{let b,n,e,t,a,p,c;function h(){n=document.createElement("div"),n.classList.add("searchbox"),n.style.position="absolute",n.style.top="10px",n.style.right="10px",n.style.zIndex=10,n.innerHTML=`<input type="search" class="searchinput" placeholder="Search..." style="vertical-align: top;"/>
		</span>`,e=n.querySelector(".searchinput"),e.style.width="240px",e.style.fontSize="14px",e.style.padding="4px 6px",e.style.color="#000",e.style.background="#fff",e.style.borderRadius="2px",e.style.border="0",e.style.outline="0",e.style.boxShadow="0 2px 18px rgba(0, 0, 0, 0.2)",e.style["-webkit-appearance"]="none",b.getRevealElement().appendChild(n),e.addEventListener("keyup",function(o){o.keyCode===13?(o.preventDefault(),function(){if(p){var m=e.value;m===""?(c&&c.remove(),t=null):(c=new g("slidecontent"),t=c.apply(m),a=0)}t&&(t.length&&t.length<=a&&(a=0),t.length>a&&(b.slide(t[a].h,t[a].v),a++))}(),p=!1):p=!0},!1),v()}function x(){n||h(),n.style.display="inline",e.focus(),e.select()}function v(){n||h(),n.style.display="none",c&&c.remove()}function g(o,m){var z=document.getElementById(o)||document.body,E=m||"EM",C=new RegExp("^(?:"+E+"|SCRIPT|FORM)$"),O=["#ff6","#a0ffff","#9f9","#f99","#f6f"],$=[],Z=0,U="",B=[];this.setRegex=function(q){q=q.trim(),U=new RegExp("("+q+")","i")},this.getRegex=function(){return U.toString().replace(/^\/\\b\(|\)\\b\/i$/g,"").replace(/\|/g," ")},this.hiliteWords=function(q){if(q!=null&&q&&U&&!C.test(q.nodeName)){if(q.hasChildNodes())for(var P=0;P<q.childNodes.length;P++)this.hiliteWords(q.childNodes[P]);var F,V;if(q.nodeType==3&&(F=q.nodeValue)&&(V=U.exec(F))){for(var G=q;G!=null&&G.nodeName!="SECTION";)G=G.parentNode;var at=b.getIndices(G),lt=B.length,L=!1;for(P=0;P<lt;P++)B[P].h===at.h&&B[P].v===at.v&&(L=!0);L||B.push(at),$[V[0].toLowerCase()]||($[V[0].toLowerCase()]=O[Z++%O.length]);var _=document.createElement(E);_.appendChild(document.createTextNode(V[0])),_.style.backgroundColor=$[V[0].toLowerCase()],_.style.fontStyle="inherit",_.style.color="#000";var ot=q.splitText(V.index);ot.nodeValue=ot.nodeValue.substring(V[0].length),q.parentNode.insertBefore(_,ot)}}},this.remove=function(){for(var q,P=document.getElementsByTagName(E);P.length&&(q=P[0]);)q.parentNode.replaceChild(q.firstChild,q)},this.apply=function(q){if(q!=null&&q)return this.remove(),this.setRegex(q),this.hiliteWords(z),B}}return{id:"search",init:o=>{b=o,b.registerKeyboardShortcut("CTRL + Shift + F","Search"),document.addEventListener("keydown",function(m){m.key=="F"&&(m.ctrlKey||m.metaKey)&&(m.preventDefault(),n||h(),n.style.display!=="inline"?x():v())},!1)},open:x}},ye={class:"flex relative box-border h-full reveal"},_e={class:"slides flex h-full w-full"},Se=["data-markdown"],ve={props:{slidescontent:{type:String,default:"Missing Document"}}},$e=Pt({...ve,__name:"Slides",setup(b){return Vt(()=>{console.log("Slides Mounted"),Ft(()=>import("./reveal.esm.ssIfNQ0c.js"),__vite__mapDeps([]),import.meta.url).then(n=>{console.log("Check",n);const e=new n.default;e.initialize({controls:!0,progress:!0,center:!0,hash:!0,transition:"none",embedded:!0,showNotes:!0,plugins:[ke,be,ee,we]}),console.log("Check",e)})}),(n,e)=>(ft(),Wt("div",ye,[_t("div",_e,[_t("section",{"data-markdown":b.slidescontent,"data-separator":"^\\r?\\n---\\r?\\n$","data-separator-notes":"^Note:"},null,8,Se)])]))}}),qe=Pt({__name:"[chapter]",setup(b){const n=Yt();console.log(n.public.repoName);const e="/"+n.public.repoName+"/";return(t,a)=>{const p=$e,c=ne,h=se;return ft(),yt(h,null,{default:Kt(({doc:x})=>[_t("div",{class:Xt(["flex font-body m-4 bg-eScienceWhite",{"overflow-hidden h-full":x._extension==="pmd","justify-center py-8":x._extension==="md"}])},[x._extension==="pmd"?(ft(),yt(p,{key:0,slidescontent:e+x._file},null,8,["slidescontent"])):(ft(),yt(c,{key:1,value:x,class:"prose-lg max-w-2xl"},null,8,["value"]))],2)]),_:1})}}});export{qe as default};
