import{f as Ft,K as Qt,M as It,c as xt,o as gt,a as _t,t as Wt,_ as Yt,B as Gt,w as Kt,b as Rt}from"#entry";import Jt from"./CwdbUuWM.js";import Xt from"./C1Rs42oI.js";import"./CN_dWvHO.js";import"./B8IaAclc.js";import"./BlTT4Lg8.js";import"./Dm9W8gQQ.js";function te(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}let ot={async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1};const Ot=/[&<>"']/,ee=new RegExp(Ot.source,"g"),Pt=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,ne=new RegExp(Pt.source,"g"),se={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Lt=b=>se[b];function Q(b,i){if(i){if(Ot.test(b))return b.replace(ee,Lt)}else if(Pt.test(b))return b.replace(ne,Lt);return b}const ie=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;function Dt(b){return b.replace(ie,((i,t)=>(t=t.toLowerCase())==="colon"?":":t.charAt(0)==="#"?t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):""))}const le=/(^|[^\[])\^/g;function D(b,i){b=typeof b=="string"?b:b.source,i=i||"";const t={replace:(e,r)=>(r=(r=r.source||r).replace(le,"$1"),b=b.replace(e,r),t),getRegex:()=>new RegExp(b,i)};return t}const re=/[^\w:]/g,ae=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function Bt(b,i,t){if(b){let e;try{e=decodeURIComponent(Dt(t)).replace(re,"").toLowerCase()}catch{return null}if(e.indexOf("javascript:")===0||e.indexOf("vbscript:")===0||e.indexOf("data:")===0)return null}i&&!ae.test(t)&&(t=(function(e,r){ut[" "+e]||(oe.test(e)?ut[" "+e]=e+"/":ut[" "+e]=mt(e,"/",!0)),e=ut[" "+e];const h=e.indexOf(":")===-1;return r.substring(0,2)==="//"?h?r:e.replace(ce,"$1")+r:r.charAt(0)==="/"?h?r:e.replace(pe,"$1")+r:e+r})(i,t));try{t=encodeURI(t).replace(/%25/g,"%")}catch{return null}return t}const ut={},oe=/^[^:]+:\/*[^/]*$/,ce=/^([^:]+:)[\s\S]*$/,pe=/^([^:]+:\/*[^/]*)[\s\S]*$/,kt={exec:function(){}};function Mt(b,i){const t=b.replace(/\|/g,((r,h,p)=>{let d=!1,w=h;for(;--w>=0&&p[w]==="\\";)d=!d;return d?"|":" |"})).split(/ \|/);let e=0;if(t[0].trim()||t.shift(),t.length>0&&!t[t.length-1].trim()&&t.pop(),t.length>i)t.splice(i);else for(;t.length<i;)t.push("");for(;e<t.length;e++)t[e]=t[e].trim().replace(/\\\|/g,"|");return t}function mt(b,i,t){const e=b.length;if(e===0)return"";let r=0;for(;r<e;){const h=b.charAt(e-r-1);if(h!==i||t){if(h===i||!t)break;r++}else r++}return b.slice(0,e-r)}function Ht(b,i){if(i<1)return"";let t="";for(;i>1;)1&i&&(t+=b),i>>=1,b+=b;return t+b}function Ct(b,i,t,e){const r=i.href,h=i.title?Q(i.title):null,p=b[1].replace(/\\([\[\]])/g,"$1");if(b[0].charAt(0)!=="!"){e.state.inLink=!0;const d={type:"link",raw:t,href:r,title:h,text:p,tokens:e.inlineTokens(p)};return e.state.inLink=!1,d}return{type:"image",raw:t,href:r,title:h,text:Q(p)}}class zt{constructor(i){this.options=i||ot}space(i){const t=this.rules.block.newline.exec(i);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(i){const t=this.rules.block.code.exec(i);if(t){const e=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?e:mt(e,`
